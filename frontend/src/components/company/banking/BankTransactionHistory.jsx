...
function BankTransactionHistory() {
  ...
  const fetchBankTransactionHistory = () => {
    axios
      .get(
        `${config.base_url}/fetch_bank_transaction_history/${transactionId}/`
      )
      .then((res) => {
                    ...
                    {history &&
                      history.map((h, index) => (
                        <tr>
                          ...
                          <td style={{ textAlign: "center" }}>{formatDate(h.date)}</td>
                          {h.action == "Created" ? (
